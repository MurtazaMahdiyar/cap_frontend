  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch(`${baseUrl}/api/v1/profile/`, requestOptions)
        ...
        .then((data) => (adminData.profile = data?.id));

      formData = new FormData();

      formData.append("profile", adminData.profile);
      formData.append("faculty", adminData.faculty);

      requestOptions.body = formData;

      await fetch(`${baseUrl}/api/v1/admins/`, requestOptions)
        .then(async (response) => {
          if (response.ok) {
            ...
            fetch(
              `${baseUrl}/api/v1/profile/${adminData.profile}/`,
              requestOptions
            );
      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        <Modal.Body>
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-4">
              <label className="ps-2">Admin Faculty: </label>
              <select
                className="form-select"
